    ...
    <section className="bg-[radial-gradient(34%_36%_at_92%_92%,rgba(173,162,255,0.32)_0%,rgba(173,162,255,0)_72%),linear-gradient(165deg,#7262FF_0%,#6149FF_38%,#5A43F2_72%,#513EDF_100%)] px-4 pb-12 pt-4 text-white">
      ...
      <div className="flex justify-end gap-2">
        <button
          ...
          onClick={onOpenGuide}
          className="flex items-center justify-center rounded-full border border-white/70 bg-white/10 px-4 py-1 text-caption text-white"
        >
          채팅 토론 가이드
        </button>
        <button
          ...
          disabled={isLeaving}
          className="flex items-center justify-center rounded-full border border-white/70 bg-white/10 px-4 py-1 text-caption text-white disabled:opacity-60"
        >
          토론방 나가기
        </button>
      </div>
