...
load_deploy_env() {
  ...
  CONTAINER_STOP_TIMEOUT_SECONDS="${CONTAINER_STOP_TIMEOUT_SECONDS:-30}"
  AWSLOGS_GROUP="${AWSLOGS_GROUP:-/doktori/frontend}"
  AWSLOGS_STREAM_PREFIX="${AWSLOGS_STREAM_PREFIX:-frontend}"
  AWSLOGS_CREATE_GROUP="${AWSLOGS_CREATE_GROUP:-false}"
